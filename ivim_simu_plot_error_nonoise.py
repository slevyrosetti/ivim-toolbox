...
# -*- coding: utf-8 -*-
"""
Plot fitting error computed from simulations with function "ivim_simu_plot_error_nonoise".
...
if __name__ == "__main__":
    ...
    # parse arguments
    parser = argparse.ArgumentParser(description='This program produces the figures plotting the estimation errors from simulations run with function \"ivim_simu_compute_error_nonoise\".')
