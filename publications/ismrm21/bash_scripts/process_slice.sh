...
mkdir tmp_dcm2nii
dcm2niix -z y -m y -o tmp_dcm2nii ${dcm_path}/*_DWI_ZOOMit_IVIM_3dir_1b_slice_P_A
...
mkdir tmp_dcm2nii
dcm2niix -z y -m y -o tmp_dcm2nii ${dcm_path}/*_DWI_ZOOMit_IVIM_3dir_1b_slice_A_P
...
# sct_dmri_moco -i rvs_ungibbs.nii.gz -bvec rvs.bvec -ofolder rvs_dmri_moco
